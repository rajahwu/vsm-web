...
export class VsmBrand {
  ...
  static toCSSVariables() {
    ...
    // Brand Specific - VSM often uses indigo/slate
    vars.push('  --color-brand-primary: var(--color-indigo-500);');
    vars.push('  --color-brand-secondary: var(--color-slate-500);');
