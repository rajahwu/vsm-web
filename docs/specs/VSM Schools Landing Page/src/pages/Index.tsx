...
import { Mountain, Eye, Users, Cog, Star, ArrowRight, Mail, User } from "lucide-react";
      ...
      <section className="py-24 px-4 bg-hero">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-8 text-white/80">
            <a href="#bootcamp" className="hover:text-white transition-smooth" onClick={(e) => {
              e.preventDefault();
              document.querySelector('[data-section="bootcamp"]')?.scrollIntoView({ behavior: 'smooth' });
            }}>View Courses</a>
            <Separator orientation="vertical" className="hidden md:block h-4 bg-white/30" />
            <a href="#pillars" className="hover:text-white transition-smooth" onClick={(e) => {
              e.preventDefault();
              document.querySelector('[data-section="pillars"]')?.scrollIntoView({ behavior: 'smooth' });
            }}>Learning Framework</a>
            <Separator orientation="vertical" className="hidden md:block h-4 bg-white/30" />
            <a href="#testimonials" className="hover:text-white transition-smooth" onClick={(e) => {
              e.preventDefault();
              document.querySelector('[data-section="testimonials"]')?.scrollIntoView({ behavior: 'smooth' });
            }}>Community Stories</a>
          </div>
        </div>
      </section>
